...
import os
import json
#typewriter effect for certain dialogue
...
def intro():
    ...
    print("2. medium")
    print("3. hard")
    print("4. abslolute fucking nightmare")
    difficulty = input(">")
    if difficulty == "1":
        ...
        print("you have chosen absolute fucking nightmare! (you are going to die btw)")
        time.sleep(2)
        print("good luck!")
        time.sleep(2)
        difflevel = 4
...
def youenterthekitchen():
    typewrite("you enter the kitchen. a plate of pancakes is on the counter. they is smells so good!! :3")
...
def middledrawer():
    ...
    surviveending()
def bottomdrawer():
    print("you open the bottom drawer. nothing is there. you close the drawer.")
    time.sleep(2)
    drawers()
def placewhereyouprobablydie():
    print("you are in a place where you will probably die. you cannot eat, you're trapped here forever. you give up on life, because you know that nobody will ever save you.")
    time.sleep(5)
    print("you know, that's pretty deep. you begin reflecting on your life. you die because of depression.")
    time.sleep(3)
    print("you died, game over!")
    time.sleep(1)
    print("score = 100")
    time.sleep(1)
    print("ending = died of depression in the void of reality")
    time.sleep(1)
    print("try again for another ending!")
    time.sleep(1)
...
def placewhereyoumightdie():
    print("you are in a place where you might die. you cannot eat, but you can survive here for a while. you wait around, hoping that someone will save you.")
    time.sleep(3)
    print("while you wait, want to hear a story?")
    choice = input("y/n >")
    if choice == "y":
        story()
    elif choice == "n":
        print("alright, suit yourself. you wait around, hoping that someone will save you.")
        print("somehow, you get teleported somewhere else.")
        placewhereyouprobablydie()
    else: print("invalid input. please choose a valid option.")
    placewhereyoumightdie()
    time.sleep(5)
    ...
    print("score = 50")
    time.sleep(1)
    print("ending = can't take a story, eh?")
    time.sleep(1)
    print("try again for another ending!")
    time.sleep(1)
    print("thank you for playing my small game! if you enjoyed, consider leaving a star on the repository! i am also open to suggestions for expanding this game, and for sequels or other ideas. please report any bugs at the repository!")
...
def placewhereyouhaveachancetodiebutisnttoomuch():
    print("you are in a place where you have a chance to die, but it isn't too much. you cannot eat, but you can survive here for a while. you wait around, hoping that someone will save you.")
    time.sleep(3)
    print("would you like to hear a story? you know what? nevermind. you need this story. i'm not going to let you choose.")
    story()
def surviveending():
    time.sleep(5)
