although this project is MIT licensed, attribution to Stuffsrc  
is very strongly requested when used in derivative works, distributions,
and other modifications or repacks. thank you, and have a wonderful morning/day/night :3
much love :3, -Stuffsrc and the Reality Pancakes "team" :3

by the way, by contributing, you agree that I can use your code and if i want to close the source of this. worry not, because if i ever decide to do that for some reason I will credit ALL contributors, even if you added or removed the slightest thing. also, all contributors will have a discount from 100% if i release this as paid. thank you for your understanding :3

--------------------------------------------------CONTRIBUTORS----------------------------------------------------


below are all the wonderful people who have contributed so far. this will be updated as more people contribute.
...
<img width="1200" height="1185" alt="4452" src="https://github.com/user-attachments/assets/e24c9eaf-c89a-4339-9500-8b93fbab1c6d" />
